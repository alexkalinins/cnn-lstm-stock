...
model.build(input_shape=(None, 10, 6))
print(model.summary())
...
MODEL_NAME = f'LSTM-v1-{int(time.time())}'
EPOCHS=5
BATCH_SIZE = 64
...
filepath = 'LSTM-{epoch:02d}-{val_mae:.3f}'
...
resh_inp = train_x[0].reshape((1,10,6))
